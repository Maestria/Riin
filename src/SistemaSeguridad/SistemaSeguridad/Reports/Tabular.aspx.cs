...
{
    public partial class Tabular : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                var reportName = seccionPages.CurrentConfiguration.AppSettings.Settings["rptTabular"].Value;
                ...
                GetQryStrParam("FechaInicio", ref reportParameters);
                GetQryStrParam("FechaFinal", ref reportParameters);
                GetQryStrParam("MontoMenor", ref reportParameters);
                GetQryStrParam("MontoMayor", ref reportParameters);
                GetQryStrParam("strTipoIncidentesId", ref reportParameters);
