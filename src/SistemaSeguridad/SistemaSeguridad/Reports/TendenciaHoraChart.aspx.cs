...
{
    public partial class TendenciaHoraChart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                var reportName = seccionPages.CurrentConfiguration.AppSettings.Settings["rptTendenciaHoraChart"].Value;
                ...
                GetQryStrParam("HoraInicio", ref reportParameters);
                GetQryStrParam("HoraFinal", ref reportParameters);
