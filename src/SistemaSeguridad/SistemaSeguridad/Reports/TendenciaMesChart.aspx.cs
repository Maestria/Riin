...
{
    public partial class TendenciaMesChart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                var reportName = seccionPages.CurrentConfiguration.AppSettings.Settings["rptTendenciaMesChart"].Value;
